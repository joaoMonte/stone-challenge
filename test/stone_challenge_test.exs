defmodule StoneChallengeTest do
  ...
  test "Make an credit with carry on a BRL account" do
  ...
  test "Make an credit with carry on a CNY account" do
  ...
  test "Make an credit with carry on a JOD account" do
